...
const SUBMODULES = [
  { to: '/admin/account/users', label: 'User account' },
  { to: '/admin/account/my-account', label: 'My account' },
]
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden text-slate-100">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        <AdminSubHeader title="Account settings" />
        <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-5 py-10 sm:px-8">
          <p className="mb-8 text-center text-slate-300">
            Choose user directory or your personal security settings.
          </p>
